...
content.loot =
{
...

    {
        ...
        { itemId = xi.item.AGILE_GORGET,          weight = 400 },
...

    {
        ...
        { itemId = xi.item.JAGD_GORGET,           weight = 400 },
        { itemId = xi.item.BLACK_ROCK,            weight =  10 },
        { itemId = xi.item.BLUE_ROCK,             weight =  10 },
        { itemId = xi.item.GREEN_ROCK,            weight =  10 },
        { itemId = xi.item.PURPLE_ROCK,           weight =  10 },
...

    {
        ...
        { itemId = xi.item.SQUARE_OF_SILK_CLOTH,  weight = 300 },
    },

    {
        { itemId = xi.item.BUNCH_OF_PAMAMAS,      weight = 1000 },
    },

    {
        { itemId = xi.item.BUNCH_OF_WILD_PAMAMAS, weight = 1000 },
    },
}
