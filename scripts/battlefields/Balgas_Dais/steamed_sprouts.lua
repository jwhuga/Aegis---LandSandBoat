...
content.loot =
{
    ...
    {
        { itemId = xi.item.GOLD_BEASTCOIN,        weight =  50 },
        { itemId = xi.item.MYTHRIL_BEASTCOIN,     weight =  50 },
        { itemId = xi.item.BLACK_ROCK,            weight =  50 },
        { itemId = xi.item.BLUE_ROCK,             weight =  50 },
        { itemId = xi.item.GREEN_ROCK,            weight =  50 },
        { itemId = xi.item.PURPLE_ROCK,           weight =  50 },
        { itemId = xi.item.RED_ROCK,              weight =  50 },
        { itemId = xi.item.TRANSLUCENT_ROCK,      weight =  50 },
        { itemId = xi.item.WHITE_ROCK,            weight =  50 },
        { itemId = xi.item.YELLOW_ROCK,           weight =  50 },
        { itemId = xi.item.AMETRINE,              weight =  50 },
        { itemId = xi.item.BLACK_PEARL,           weight =  50 },
        { itemId = xi.item.GARNET,                weight =  50 },
        { itemId = xi.item.GOSHENITE,             weight =  50 },
        { itemId = xi.item.PEARL,                 weight =  50 },
        { itemId = xi.item.PERIDOT,               weight =  50 },
        { itemId = xi.item.SPHENE,                weight =  50 },
        { itemId = xi.item.TURQUOISE,             weight =  50 },
        { itemId = xi.item.ROSEWOOD_LOG,          weight =  50 },
