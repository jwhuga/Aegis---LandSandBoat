...
{
    {
        { itemId = xi.item.GIL,                      weight = 1000, amount = 1734 }, -- TODO: Looks like gil that you get might behave like a regular treasure chest??
    },
    ...
    {
        { itemId = xi.item.ASTRAL_RING,              weight = 350 },
        { itemId = xi.item.PLATINUM_RING,            weight =  25 },
        { itemId = xi.item.SCROLL_OF_QUAKE,          weight =  25 },
        { itemId = xi.item.RAM_SKIN,                 weight =  25 },
        { itemId = xi.item.RERAISER,                 weight =  25 },
        { itemId = xi.item.MYTHRIL_INGOT,            weight =  25 },
        { itemId = xi.item.LIGHT_SPIRIT_PACT,        weight =  25 },
        { itemId = xi.item.SCROLL_OF_FREEZE,         weight =  25 },
        { itemId = xi.item.SCROLL_OF_REGEN_III,      weight =  25 },
        { itemId = xi.item.SCROLL_OF_RAISE_II,       weight =  25 },
        { itemId = xi.item.PETRIFIED_LOG,            weight =  25 },
        { itemId = xi.item.CORAL_FRAGMENT,           weight =  25 },
        { itemId = xi.item.MAHOGANY_LOG,             weight =  25 },
        { itemId = xi.item.CHUNK_OF_PLATINUM_ORE,    weight =  25 },
        { itemId = xi.item.CHUNK_OF_GOLD_ORE,        weight =  25 },
        { itemId = xi.item.CHUNK_OF_DARKSTEEL_ORE,   weight =  25 },
        { itemId = xi.item.CHUNK_OF_MYTHRIL_ORE,     weight =  25 },
        { itemId = xi.item.GOLD_INGOT,               weight =  25 },
        { itemId = xi.item.DARKSTEEL_INGOT,          weight =  25 },
        { itemId = xi.item.PLATINUM_INGOT,           weight =  25 },
        { itemId = xi.item.EBONY_LOG,                weight =  25 },
        { itemId = xi.item.RAM_HORN,                 weight =  25 },
        { itemId = xi.item.DEMON_HORN,               weight =  25 },
        { itemId = xi.item.MANTICORE_HIDE,           weight =  25 },
        { itemId = xi.item.WYVERN_SKIN,              weight =  25 },
        { itemId = xi.item.HANDFUL_OF_WYVERN_SCALES, weight =  25 },
    },
}
